            ...
            <div id="content-wrapper" class="d-flex flex-column">
                <div id="content">
                    ...
                    <div style="padding: 50px">
                        <h4 style="color: #006dcc"><a href="${context}/Cate/Create">+ Create new</a></h4>
                        <center>
                            <h2 style="color: #006dcc">Category Manager</h2>
                                ...
                                <tbody>
                                    <c:forEach var="i" items="${list}">
                                        <tr>
                                            ...
                                            <td>${i.name}</td>
                                            <td>
                                                <a href="${context}/Cate/Delete?id=${i.CEId}"><i class="fas fa-trash-alt" aria-hidden="true"></i></a>&nbsp;&nbsp;&nbsp; || &nbsp;&nbsp;&nbsp;  
                                                <a href="${context}/Cate/Edit?id=${i.CEId}"><i class="fas fa-pencil-alt" aria-hidden="true"></i></a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
