                                ...
                                <tbody>
                                    <c:forEach var="i" items="${list}">
                                        <tr>
                                            ...
                                            <td>${i.name}</td>
                                            <td>
                                                <a href="${context}/Animals/Delete?id=${i.CFId}"><i class="fas fa-trash-alt" aria-hidden="true"></i></a>&nbsp;&nbsp;&nbsp; || &nbsp;&nbsp;&nbsp;
                                                <a href="${context}/Animals/Edit?id=${i.CFId}"><i class="fas fa-pencil-alt" aria-hidden="true"></i></a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
