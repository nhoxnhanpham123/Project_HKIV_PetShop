        ...
        <div id="wrapper">
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                <div id="content">
                    ...
                    <div>
                        <center>
                            <h1>Update Hotel Pet</h1>
                            <form class="form-horizontal" action="${context}/Hotel/Update"  method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <input id="namePet" name="namePet" value="${hotel.namePet}" placeholder="Food Name" class="form-control input-md" required="" type="text">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-4">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <input id="price" name="price" value="${hotel.price}" placeholder="Price" class="form-control input-md" required="" type="price">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-4">
                                        <input id="status" name="status" value="${hotel.status}" placeholder="Status" class="form-control input-md" required="" type="text">
                                    </div>
                                </div>
                                <!-- Text input-->
                                <div class="form-group row">
