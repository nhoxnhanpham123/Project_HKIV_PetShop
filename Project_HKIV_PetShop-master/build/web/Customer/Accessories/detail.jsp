...
<html lang="en">
    <head>
        <title>Detail Accessories</title>
                                    ...
                                    <li>
                                        <div class="quantity buttons_added" style="margin-top:30px; margin-bottom: 20px;">
                                            <form action="${context}/Order/Store" method="Get">
                                                <input type="text" name="ESId" value="${acc.ESId}" style="display: none"/>
                                                <input type="button" value="-" class="minus">
                                                <input type="number" step="1" min="1" max="" name="quantityAcc" value="1" title="Qty" class="input-text qty text" size="4" pattern="" inputmode="">
                                                <input type="button" value="+" class="plus">
                                                <br/>
                                                <br/>
                                                <button style="border: none; background-color: #00bd56;
                                                    border-radius: 5px; padding: 5px  15px; color: whitesmoke">Add to Cart
                                                </button>
                                            </form>
                                        </div>
                                    </li>
