 ...
 * @author DUY
 */
@WebServlet(name = "cusHotelController", urlPatterns = {"/cusHotelController/*"})
public class cusHotelController extends HttpServlet {
    @EJB
    ...
    private void getViewAll(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.setAttribute("member", membersFacade.findAll());
